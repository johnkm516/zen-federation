...
export const environment: EnvironmentBase = {
  ...
  production: false,
  expressPort: process.env.CRM_API_PORT,
  dbSourceURL: `postgres://${process.env.PGUSER}:${process.env.PGPASSWORD}@localhost:${process.env.CRM_PGDATABASE_PORT}/${process.env.CRM_PGDATABASE}`,
